...
public class DungeonGame extends Game {
    ...
    // В GameMap в enum CellType добавлен конструктор, со стоимостью перехода
    // юнит не может шагнуть в ячейку если не хватает шагов.
    // +2. Добавьте клеткам стоимость перехода и подшейте это к логике юнитов
    //  добавил в GameMap тип клетки SWAMP
    // +3. На карте случайно разместите сколько-то клеток стоимость 2, при
    // отрисовке их можно сделать более темными
    // + проверка находится в WorldRender
    // Показываем защиту и к какому виду оружия неуязвимость
