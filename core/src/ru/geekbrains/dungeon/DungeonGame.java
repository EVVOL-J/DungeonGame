...
public class DungeonGame extends Game {
    ...
    // Домашнее задание:
    //Сегодня 08.12.2020 немного не успел доделать, до 10 вечера постараюсь все пункты выполнить.Пуш обновлю.
    // +1. Разобраться с кодом
    // +2. На деревьях растут ягоды (не на всех), их можно собирать. Каждый 5 ход,
    // на случайном дереве растет ягода
    // Падает на 1 при смене раунда, грубо говоря с каждым раундом не восполняется здоровье
